...
def getDataFromTxt(txt, with_landmark=True):
    ...
    """
    dirname = os.path.dirname(txt) #D:\deep_landmark\cnn-face-data
    ...
    for line in lines:
        ...
        img_path = os.path.join(dirname, components[0]) # file path #D:\deep_landmark\cnn-face-data\\lfw_5590\Aaron_Eckhart_0001.jpg
        # bounding box, (left, right, top, bottom)
        bbox = (components[1], components[2], components[3], components[4])  #face fame
