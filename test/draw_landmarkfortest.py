...
import cv2
import sys
caffe_root = 'D:/caffe-master/'  # this file is expected to be in {caffe_root}/examples
...
class Landmarker(object):
    ...
    def _level(self, img, bbox, landmark, cnns, padding):
        ...
        for i in range(5):
            ...
            #transform patch datafram to face datafram for key point position of proportion
...
if __name__ == '__main__':
    result_path = r'D:\MyProj\caffe\result'
    test_folder = './test_pic/'
